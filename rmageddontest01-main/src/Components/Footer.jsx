  ...
  >
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-[1] flex flex-col justify-start mr-10">
        ...
        <p
          className={`font-poppins font-normal text-dimWhite text-[15px] leading-[23px]  mt-4 max-w-[435px]`}
        >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      ...
      <div className="flex flex-row md:mt-0 mt-6 justify-between">
        <SocialIcon
          target="_blank"
          url="https://www.instagram.com/sggs_rnxg/"
          className="social"
        />
        <SocialIcon
          target="_blank"
          url="https://www.facebook.com/rnxgsggs"
          className="social"
        />
        <SocialIcon
          target="_blank"
          url="https://www.linkedin.com/search/results/all/?heroEntityKey=urn%3Ali%3Aorganization%3A31238246&keywords=rnxg&origin=RICH_QUERY_SUGGESTION&position=0&searchId=d79dd991-69ab-4670-9543-5643e13efd28&sid=gg7"
          className="social"
        />
        <SocialIcon
          target="_blank"
          url="https://www.youtube.com/channel/UC9fFrYx9UEpxDjS9YO6t2FA"
          className="social"
        />
      </div>
    </div>
