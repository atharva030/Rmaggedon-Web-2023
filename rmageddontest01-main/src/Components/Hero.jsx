  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Games, Rmaggedon 2023,Rmaggedon 23, Rmaggedon, logo, iron man"
        />
      </Helmet>
      <section
        id="home"
      ...
      >
        ...
        >
          ...
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            Unleash the full potential of your robotic creations and showcase
            your skills to the elite in the field of robotics at RNXG. Compete
            for recognition and prizes at Rmageddon and be a part of the most
            exciting college robotics event of the year!
          </p>
        </div>
        <div
